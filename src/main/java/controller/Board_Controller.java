...
public class Board_Controller extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (path.equals("/insertBoard.do")) {
			...
			/*
			 * System.out.println("title : " + title); System.out.println("write : " +
...
//		    System.out.println(" 검색어 : " + searchKeword);
			...
			// 변수값 출력 :
			/*
			 * System.out.println(title); System.out.println(write);
			 * System.out.println(content); System.out.println(seq);
			 */

			// 2. 변수를 DTO에 setter 주입
			BoardDTO dto = new BoardDTO();
			dto.setTitle(title);
			dto.setWrite(write);
			dto.setContent(content);
